...
Blockly.Language.grove_piezo_buzzer = {
  ...
  init: function() {
    ...
    this.appendDummyInput("")
        ...
        .appendTitle(new Blockly.FieldDropdown(profile.default.digital), "PIN")
        .appendTitle("état")
        .appendTitle(new Blockly.FieldDropdown([["Activé", "HIGH"], ["Desactivé", "LOW"]]), "STAT");    
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Language.grove_relay = {
  ...
  init: function() {
    ...
    this.appendDummyInput("")
        ...
        .appendTitle(new Blockly.FieldDropdown(profile.default.digital), "PIN")
        .appendTitle("état")
        .appendTitle(new Blockly.FieldDropdown([["Fermé", "HIGH"], ["Ouvert", "LOW"]]), "STAT");    
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Language.grove_temporature_sensor = {
  ...
  init: function() {
    this.setColour(10);
    this.appendDummyInput("")
        .appendTitle("Capteur de Température")
...
Blockly.Language.grove_serial_lcd_power = {
  ...
  init: function() {
    ...
    this.appendDummyInput("")
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendTitle("Etat")
        .appendTitle(new Blockly.FieldDropdown([["Allumé", "ON"], ["Eteint", "OFF"]]), "STAT"); 
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
category: 'Grove LCD',
  ...
  init: function() {
    ...
    this.appendDummyInput("")
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendTitle("Effet")
        .appendTitle(new Blockly.FieldDropdown([["Défile vers la gauche", "LEFT"], ["Défile vers la doite", "RIGHT"], ["Auto défilement", "AUTO"]]), "STAT"); 
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip('Turn LCD power on/off');
  }
...
Blockly.Language.grove_pir_motion_sensor = {
  ...
  init: function() {
    this.setColour(190);
    this.appendDummyInput("")
        .appendTitle("PIR Capteur de présence")
...
Blockly.Language.grove_ultrasonic_ranger = {
  ...
  init: function() {
    this.setColour(190);
    this.appendDummyInput("")
	      .appendTitle("Capteur de distance à ultrasons")
