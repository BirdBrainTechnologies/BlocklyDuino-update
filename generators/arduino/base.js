...
Blockly.Language.base_delay = {
  ...
  init: function() {
    ...
    this.appendValueInput("DELAY_TIME", Number)
        .appendTitle("Délais en ms")
        .setCheck(Number);
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip('fais une pause, de tant de millisecondes');
  }
};
...
Blockly.Language.inout_buildin_led = {
   ...
   init: function() {
     this.setColour(190);
     this.appendDummyInput("")
	       .appendTitle("Led numéro 13 sur l'arduino")
	       .appendTitle(new Blockly.FieldDropdown([["Allumée", "HIGH"], ["Eteinte", "LOW"]]), "STAT");
     this.setPreviousStatement(true, null);
     this.setNextStatement(true, null);
...
Blockly.Language.inout_digital_write = {
  ...
  init: function() {
    this.setColour(230);
    this.appendDummyInput("")
	      .appendTitle("Ecrire sur l'Entrée Digitale Num#")
	      .appendTitle(new Blockly.FieldDropdown(profile.default.digital), "PIN")
      	.appendTitle("Etat")
      	.appendTitle(new Blockly.FieldDropdown([["Haut 5V", "HIGH"], ["Bas 0V", "LOW"]]), "STAT");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Language.inout_digital_read = {
  ...
  init: function() {
    this.setColour(230);
    this.appendDummyInput("")
	      .appendTitle("Lire L'Entrée Digitale Num#")
	      .appendTitle(new Blockly.FieldDropdown(profile.default.digital), "PIN");
...
Blockly.Language.inout_analog_write = {
  ...
  init: function() {
    this.setColour(230);
    this.appendDummyInput("")
        .appendTitle("Ecrire en analogique sur la broche#")
...
Blockly.Language.tone = {
  ...
  init: function() {
    this.setColour(230);
    this.appendDummyInput("")
        .appendTitle("Emet un son sur la broche#")
        .appendTitle(new Blockly.FieldDropdown(profile.default.digital), "PIN")
    this.appendValueInput("NUM", Number)
        .appendTitle("Fréquence")
        .setCheck(Number);
    this.appendValueInput("TPS", Number)
        .appendTitle("Durée en ms")
        .setCheck(Number);
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip('Emet un son sur la broche selectionnée, ');
  }
};
...
Blockly.Language.notone = {
  ...
  init: function() {
    this.setColour(230);
    this.appendDummyInput("")
        .appendTitle("Coupe le son sur la broche#")
        .appendTitle(new Blockly.FieldDropdown(profile.default.digital), "PIN")      
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Language.inout_analog_read = {
  ...
  init: function() {
    this.setColour(230);
    this.appendDummyInput("")
        .appendTitle("Lire en Analogique sur l'Entrée Num#")
        .appendTitle(new Blockly.FieldDropdown(profile.default.analog), "PIN");
...
Blockly.Language.inout_highlow = {
  ...
  init: function() {
    this.setColour(230);
    this.appendDummyInput("")
        .appendTitle(new Blockly.FieldDropdown([["Haut 5V", "HIGH"], ["Bas 0V", "LOW"]]), 'BOOL')
    this.setOutput(true, Boolean);
...
Blockly.Language.inout_onoff = {
  ...
  init: function() {
    this.setColour(230);
    this.appendDummyInput("")
        .appendTitle(new Blockly.FieldDropdown([["Allumée", "HIGH"], ["Eteinte", "LOW"]]), 'BOOL')
    this.setOutput(true, Boolean);
    this.setTooltip(Blockly.LANG_LOGIC_BOOLEAN_TOOLTIP_1);
  }
};
...
Blockly.Language.servo_move = {
  category: 'Servo moteurs',
  helpUrl: 'http://www.arduino.cc/playground/ComponentLib/servo',
  init: function() {
    this.setColour(190);
    this.appendDummyInput("")
        .appendTitle("Servomoteur")
...
Blockly.Language.serial_print = {
  ...
  init: function() {
    ...
    this.appendValueInput("CONTENT", String)
        .appendTitle("Ecrire sur le port Série Usb");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
